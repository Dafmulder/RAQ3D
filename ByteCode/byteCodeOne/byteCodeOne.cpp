...
uint8_t sum()
{
	...
	loadLine(byteBuffer[4]);	// Load program line into working memory
	(*OP[byteBuffer[0]])();		// Execute line and show
	return(0);
}
...
uint8_t compex()
{
	...
	loadLine(byteBuffer[3]);	// Load program line into working memory
	(*OP[byteBuffer[0]])();		// Execute line and show
	return(0);
}
